...
function initializePlutonicationDAppClientWithModal(accessCredentials, onReceivePubkey) {
    return __awaiter(this, void 0, void 0, function () {
        var modal;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    modal = getPlutonicationModal();
                    modal.openModal(accessCredentials);
                    return [4 /*yield*/, initializePlutonicationDAppClient(accessCredentials, function (receivedPubkey) {
...
exports.initializePlutonicationDAppClientWithModal = initializePlutonicationDAppClientWithModal;
function getPlutonicationModal() {
    var plutonicationModals = document.getElementsByTagName('plutonication-modal');
