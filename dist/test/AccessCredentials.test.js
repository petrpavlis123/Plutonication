...
describe("AccessCredentials", function () {
    test("No parameters", function () {
        var accessCredentials = new __1.AccessCredentials();
    ...
    test("With parameters", function () {
        ...
        var accessCredentials = new __1.AccessCredentials(url, key, name, icon);
    ...
    test("Generate key testing", function () {
        var key = __1.AccessCredentials.GenerateKey();
        var isHex = /^[0-9A-Fa-f]+$/i.test(key);
        expect(isHex).toBe(true);
    });
    test("ToUri testing", function () {
        var accessCredentials = new __1.AccessCredentials("wss://plutonication-acnha.ondigitalocean.app/", "1", "Galaxy Logic Game", "https://rostislavlitovkin.pythonanywhere.com/logo");
